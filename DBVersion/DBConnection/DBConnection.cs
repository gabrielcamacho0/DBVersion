...
namespace DBVersion.DBConnection
{
    public class DBConnection
    {
        ...
        public DBConnection()
        {
            string cadenaConexion = configuration.GetConnectionString("dbversion");
            string db = "dbversion";
            string usuario = "sabit";
            string clave = "Inn0v@c10n";
            conexion = new SqlConnection(String.Format(cadenaConexion, db, usuario, clave));
            //conexion = new SqlConnection(configuration.GetConnectionString("dbversion"));
        }
